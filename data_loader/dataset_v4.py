...
class Dataset():
    ...
    def create_directory(self):
        ...
        if self.for_what == "training_source":
            ...
            if os.path.exists(self.train_folder + "/source_img_patches/"):
                ...
                #normalize 
                self.Xs_train =  PreProcess.source_norm(self)
    ...
    def array_torch(self):
        if os.path.exists(self.data_folder + "/npy/Xs_train.npy") and os.path.exists(self.data_folder + "/npy/Ys_train.npy") and os.path.exists(self.data_folder + "/npy/Xt_train.npy"):
            self.Xs_train = np.load(self.data_folder + "/npy/Xs_subset_vhr.npy")
            self.Ys_train = np.load(self.data_folder + "/npy/Ys_subset_vhr.npy")
            self.Xt_train = np.load(self.data_folder + "/npy/Xt_subset_vhr.npy")
            self.Yt_train = np.load(self.data_folder + "/npy/Yt_subset_vhr.npy")
        ...
        #for train source dataset
            ...
            if os.path.exists(self.data_folder + "/npy/Xtest.npy"):
                self.Xtest = np.load(self.data_folder + "/npy/Xtest.npy")
            ...
            #for testing dataset
            self.tensor_xp = torch.Tensor(self.Xtest.astype(np.int32)) 
            self.tensor_yp = torch.Tensor(self.Ytest.astype(np.int32)) 
